...
<div id="project-details-area" class="project-details-area section pb-100 pt-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-12 mb-30">
                <div class="project-details-content">
                    <div class="image mb-40">
                        <img src="{{ asset($project->image) }}" alt="{{ $project->title }}" style="width: 100%; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
                    </div>
                    <h2 style="font-size: 36px; font-weight: 800; color: #333; margin-bottom: 25px;">{{ $project->title }}</h2>
                    <div class="meta mb-30" style="display: flex; gap: 20px; color: #666; font-size: 14px;">
                        <span><i class="fa fa-calendar text-primary mr-2"></i> {{ $project->created_at->format('d M, Y') }}</span>
                        <span><i class="fa fa-map-marker text-primary mr-2"></i> {{ $project->location }}</span>
                        <span class="text-uppercase font-weight-bold" style="color: #ff9f6f;">{{ $project->status }}</span>
                    </div>
            ...
            <div class="col-lg-4 col-12 mb-30">
                <div class="sidebar">
                    <div class="widget mb-40" style="background: #f9f9f9; padding: 30px; border-radius: 10px;">
                        <h4 style="font-weight: 700; margin-bottom: 20px; color: #333;">Project Details</h4>
                        <ul style="list-style: none; padding: 0; margin: 0;">
                            <li style="margin-bottom: 15px; border-bottom: 1px solid #eee; padding-bottom: 15px;">
                                ...
                                <span style="color: #666;">{{ ucfirst($project->status) }}</span>
                            </li>
                            <li style="margin-bottom: 15px; border-bottom: 1px solid #eee; padding-bottom: 15px;">
                            ...
                            <li style="margin-bottom: 15px; border-bottom: 1px solid #eee; padding-bottom: 15px;">
                                ...
                                <span style="color: #666;">{{ $project->start_date ? \Carbon\Carbon::parse($project->start_date)->format('d M, Y') : 'N/A' }}</span>
                            </li>
                        </ul>
                    </div>
