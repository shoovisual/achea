    ...
    ((jQuery.mbYTPlayer = {
        ...
        buildPlayer: function (options) {
            return this.each(function () {
                ...
                if (
                    ...
                    var overlay = jQuery("<div/>").css({ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }).addClass("mbYTP_overlay");
                    YTPlayer.isPlayer &&
        ...
        getDataFromAPI: function (a) {
            ...
            !a.isPlayer ||
                ...
                ((a.loading = jQuery("<div/>").addClass("loading").html("Loading").hide()), jQuery(a).append(a.loading), a.loading.fadeIn());
        },
        ...
        playlist: function (a, b, c, d) {
            ...
            return (
                ...
                f.videoID || ((f.videos = a), (f.videoCounter = 0), (f.videoLength = a.length), jQuery(f).data("property", a[0]), jQuery(f).mb_YTPlayer()),
                "function" == typeof c &&
        ...
        playNext: function (a) {
            var b = this.get(0);
            return (
                b.checkForStartAt && (clearTimeout(b.checkForStartAt), clearInterval(b.getState)),
                b.videoCounter++,
                b.videoCounter >= b.videoLength && a && (b.videoCounter = 0),
                b.videoCounter < b.videoLength ? jQuery(b).YTPChangeMovie(b.videos[b.videoCounter]) : b.videoCounter--,
                this
            );
        },
        playPrev: function () {
            ...
            ((c.opt.startAt = 0),
                ...
                jQuery(c.playerEl).CSSAnimate({ opacity: 0 }, c.opt.fadeOnStartTime, function () {
                    ...
                    ((a.time = c.currentTime),
                        ...
                        jQuery(c)
                            .YTPGetPlayer()
                            .cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + c.videoID), 1, c.opt.quality),
            ...
            return (
                YTPlayer.isAlone
                    ? (jQuery(document).off("mousemove.YTPlayer"),
                      ...
                      real
                          ? cancelFullscreen()
                          : (videoWrapper.CSSAnimate({ opacity: YTPlayer.opt.opacity }, YTPlayer.opt.fadeOnStartTime), videoWrapper.css({ zIndex: 0 })),
                      fullScreenBtn.html(jQuery.mbYTPlayer.controls.onlyYT),
                      (YTPlayer.isAlone = !1))
                    : (jQuery(document).on("mousemove.YTPlayer", function (a) {
                      ...
                      real
                          ? (videoWrapper.css({ opacity: 0 }),
                            ...
                            setTimeout(function () {
                                (videoWrapper.CSSAnimate({ opacity: 1 }, YTPlayer.opt.fadeOnStartTime),
                                    YTPlayer.wrapper.append(controls),
                                    jQuery(YTPlayer).optimizeDisplay(),
                                    YTPlayer.player.seekTo(YTPlayer.player.getCurrentTime() + 0.1, !0));
                            }, 500))
                          : videoWrapper.css({ zIndex: 1e4 }).CSSAnimate({ opacity: 1 }, YTPlayer.opt.fadeOnStartTime),
        ...
        play: function () {
            ...
            (a.player.playVideo(),
                a.wrapper.CSSAnimate({ opacity: a.isAlone ? 1 : a.opt.opacity }, 2 * a.opt.fadeOnStartTime),
        ...
        removeMask: function () {
            ...
            return (
                b.CSSAnimate({ opacity: 0 }, a.opt.fadeOnStartTime, function () {
                    ((a.hasMask = !1),
                        b.css({ backgroundImage: "", backgroundRepeat: "", backgroundPosition: "", backgroundSize: "" }),
                      ...
                      void (YTPlayer.getState = setInterval(function () {
                          ...
                          if (
                              ...
                              1 == YTPlayer.player.getPlayerState() &&
                                  (parseFloat(YTPlayer.player.getDuration() - 1.5) < YTPlayer.player.getCurrentTime() ||
        ...
        (jQuery.fn.optimizeDisplay = function (a) {
            ...
            if (b.opt.optimizeDisplay) {
                ...
                ((g.width = h.outerWidth()),
                    ...
                    (d.width = g.width),
                    (d.height = "16/9" == b.opt.ratio ? Math.ceil(d.width * (9 / 16)) : Math.ceil(0.75 * d.width)),
                    (d.marginTop = -((d.height - g.height) / 2)),
                    (d.marginLeft = 0));
                var i = d.height < g.height;
                i &&
                    ((d.height = g.height),
                    (d.width = "16/9" == b.opt.ratio ? Math.floor(d.height * (16 / 9)) : Math.floor(d.height * (4 / 3))),
                    (d.marginTop = 0),
        ...
        normalizeCss: function (a) {
            ...
            for (var c in b) {
                ...
                ("x" === c && ((d = jQuery.CSS.sfx + "transform"), (b[d] = b[d] || ""), (b[d] += " translateX(" + setUnit(a[c], "px") + ")"), delete b[c]),
                    ...
                    "rotateX" === c &&
                        ((d = jQuery.CSS.sfx + "transform"), (b[d] = b[d] || ""), (b[d] += " rotateX(" + setUnit(a[c], "deg") + ")"), delete b[c]),
                    "rotateY" === c &&
                        ((d = jQuery.CSS.sfx + "transform"), (b[d] = b[d] || ""), (b[d] += " rotateY(" + setUnit(a[c], "deg") + ")"), delete b[c]),
                    "rotateZ" === c &&
                        ((d = jQuery.CSS.sfx + "transform"), (b[d] = b[d] || ""), (b[d] += " rotateZ(" + setUnit(a[c], "deg") + ")"), delete b[c]),
                    ...
                    "perspective" === c &&
                        ((d = jQuery.CSS.sfx + "transform"), (b[d] = b[d] || ""), (b[d] += " perspective(" + setUnit(a[c], "px") + ")"), delete b[c]));
            }
            return b;
        },
        getProp: function (a) {
